...
module.exports = function (app) {
    ...
    app.post('/api/blog/save', blogs.editBlog);
    ...
    // widgets
    app.get('/api/widgets', widgets.loadAllWidgets);
    app.get('/api/widget', widgets.loadWidget);
    app.post('/api/widget', widgets.saveWidget);
    app.del('/api/widget', widgets.removeWidget);
